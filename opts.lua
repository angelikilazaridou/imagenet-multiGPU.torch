...
function M.parse(arg)
    ...
    cmd:option('-nClasses',        766, 'number of classes in the dataset')
    ------------- Training options --------------------
    ...
    cmd:option('-neg_samples',5,'Negative samples')
    cmd:option('-wvectors','./DATA/word2vec','Directory where word vectors are')
